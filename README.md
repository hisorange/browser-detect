...
| Browser::osName() | Operating system's human friendly name like Windows XP, MacOS 10. | _(string)_ |
| Browser::osFamily() | Operating system's vendor like Linux, Windows, MacOS. | _(string)_ |
| Browser::osVersion() | Operating system's human friendly version like XP, Vista, 10. | _(integer)_ |
| Browser::osVersionMajor() | Operating system's [semantic](https://semver.org/) major version. | _(integer)_ |
| Browser::osVersionMinor() | Operating system's [semantic](https://semver.org/) minor version. | _(integer)_ |
| Browser::osVersionPatch() | Operating system's [semantic](https://semver.org/) patch version. | _(integer)_ |
...
If you are useing laravel 5.4 and below you have to add the service provider in your **config/app.php** like this:
