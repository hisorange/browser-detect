...
$details = [
  ...
  [
    ...
    'elements' => [
      ...
      ['Browser Familt', 'browserFamily', 'string'],
  ...
  [
    ...
    'elements' => [
      ...
      ['Platform Familt', 'platformFamily', 'string'],
...
<head>
  ...
  <meta name="content" content="Easy to use package to identify the visitor's browser details and device type." />
...
<body class="pb-96">
  ...
  <nav class="container mx-auto flex py-6 border-b border-slate-500 items-center justify-between">
    ...
    <a href="https://github.com/hisorange/browser-detect" class="inline-block">
      <img src="/assets/GitHub-Mark-64px.png" class="h-16" alt="Github Repository Logo">
    </a>
  </nav>

  <main class="flex container mx-auto py-8 text-gray-800 border-b border-slate-500">
    <div class="shrink pr-8">
      <span class="material-icons material-icons-outlined text-9xl antialiased text-teal-400 transition-colors duration-500">
        <?php echo $deviceIcon; ?>
      </span>
    </div>
        ...
        <table class="border-separate w-full">
          <tbody>
            <tr>
              ...
              <td class="indent-8"><?php echo htmlentities($result->userAgent()) ?></td>
            </tr>
  ...
  <div class="container mx-auto">
    ...
    <?php foreach ($commons as $ua) : ?>
      <div class="clear-both indent-2">
        <span class="material-icons material-icons-outlined text-lg float-left">
          chevron_right
        </span>

        <a href="/?agent=<?php echo urlencode($ua) ?>" class="text-teal-500 hover:text-teal-300"><?php echo $ua ?></a>
      </div>
    <?php endforeach; ?>
  </div>
  ...
  <div class="container mx-auto my-8 pt-8 border-t text-2xl border-slate-500">
    <p class="text-center">The result above is generated by the <b>hisorange/browser-detect</b> PHP library, <a href="https://github.com/hisorange/browser-detect" class="text-teal-500 hover:underline">click here</a> to learn more.</p>
  </div>
</body>
